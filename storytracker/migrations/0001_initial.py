# Generated by Django 3.2.25 on 2025-04-08 00:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.club')),
            ],
            options={
                'verbose_name': 'Player',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stories', to='storytracker.club')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_out', to='storytracker.club')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.player')),
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers', to='storytracker.season')),
                ('story', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers', to='storytracker.story')),
                ('to_club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_in', to='storytracker.club')),
            ],
        ),
        migrations.AddField(
            model_name='season',
            name='story',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seasons', to='storytracker.story'),
        ),
        migrations.CreateModel(
            name='PlayerStats',
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.player')),
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_stats', to='storytracker.season')),
                ('story', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_stats', to='storytracker.story')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.competition')),
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competition_winners', to='storytracker.season')),
                ('story', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competition_winners', to='storytracker.story')),
                ('winner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.club')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_stats', to='storytracker.competition')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competition_stats', to='storytracker.player')),
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competition_player_stats', to='storytracker.season')),
                ('story', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competition_player_stats', to='storytracker.story')),
            ],
        ),
        migrations.AddIndex(
            model_name='competition',
            index=models.Index(fields=['name'], name='storytracke_name_094f0a_idx'),
        ),
        migrations.AddIndex(
            model_name='competition',
            index=models.Index(fields=['country'], name='storytracke_country_360fa0_idx'),
        ),
        ...
        migrations.AddField(
            model_name='club',
            name='league',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.competition'),
        ),
        migrations.AddField(
            model_name='awardwinner',
            name='award',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.individualaward'),
        ),
        migrations.AddField(
            model_name='awardwinner',
            name='player',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='storytracker.player'),
        ),
        migrations.AddField(
            model_name='awardwinner',
            name='season',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='award_winners', to='storytracker.season'),
        ),
        migrations.AddField(
            model_name='awardwinner',
            name='story',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='award_winners', to='storytracker.story'),
        ),
        ...
        migrations.AddIndex(
            model_name='story',
            index=models.Index(fields=['user', 'created_at'], name='storytracke_user_id_18a98e_idx'),
        ),
        migrations.AddIndex(
            model_name='story',
            index=models.Index(fields=['status', 'is_public'], name='storytracke_status_4b575f_idx'),
        ),
        migrations.AddIndex(
            model_name='season',
            index=models.Index(fields=['story', 'is_current'], name='storytracke_story_i_d7b9b7_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='season',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['-goals'], name='storytracke_goals_708558_idx'),
        ),
        migrations.AddIndex(
            model_name='playerstats',
            index=models.Index(fields=['-average_rating'], name='storytracke_average_56f085_idx'),
        ),
        migrations.AddIndex(
            model_name='playerstats',
            index=models.Index(fields=['-assists'], name='storytracke_assists_9c5926_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='playerstats',
        ...
        migrations.AddIndex(
            model_name='player',
            index=models.Index(fields=['name', 'overall'], name='storytracke_name_ba8087_idx'),
        ),
        migrations.AddIndex(
            model_name='player',
            index=models.Index(fields=['club', 'positions'], name='storytracke_club_id_c0de1f_idx'),
        ),
        migrations.AddConstraint(
            model_name='player',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['competition', '-goals'], name='storytracke_competi_8c7645_idx'),
        ),
        migrations.AddIndex(
            model_name='competitionplayerstats',
            index=models.Index(fields=['competition', '-average_rating'], name='storytracke_competi_b614d1_idx'),
        ),
        migrations.AddIndex(
            model_name='competitionplayerstats',
            index=models.Index(fields=['competition', '-assists'], name='storytracke_competi_27910a_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='competitionplayerstats',
        ...
        migrations.AddIndex(
            model_name='club',
            index=models.Index(fields=['name'], name='storytracke_name_1a62c4_idx'),
        ),
        migrations.AddIndex(
            model_name='club',
            index=models.Index(fields=['country'], name='storytracke_country_72a3e4_idx'),
        ),
        migrations.AddIndex(
            model_name='club',
            index=models.Index(fields=['overall'], name='storytracke_overall_29e21c_idx'),
        ),
        migrations.AddConstraint(
            model_name='club',
